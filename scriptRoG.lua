...
local myData = loadstring(game:HttpGet("https://raw.githubusercontent.com/Alin2710/scripts/main/settings.lua"))().new("Ro-Ghoul Autofarm", {
    Skills = {
        E = false,
        F = false,
        C = false,
        ...
        pcall(function()
            if player.Character.Humanoid.Health > 0 and player.Character.HumanoidRootPart and player.Character.Remotes.KeyEvent then
                ...
                if npc then
                    ...
                    labels("text", "Hp del monke: "..player.Character.Humanoid.Health)
